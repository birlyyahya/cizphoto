<x-layouts.app.general>
    <flux:main>
        ...
        <img src="{{asset('storage/background/pink.webp')}}" class="blur-xl z-10 absolute w-2/5 top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 opacity-70 rounded-full bg-contain bg-no-repeat bg-center" alt="background" srcset="">
